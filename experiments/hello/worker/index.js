...
const options = {
	...
	readQueue: 'hello_quiz_dbread',
	writeQueue: 'hello_quiz_dbwrite',
	taskQueue: 'hello_quiz_taskworker',
};
...
worker.init()
	.then(() => {
		...
		worker.useHandler(defaultHandler, connection, 'hello', transactionOps);
		worker.start();
	})
	.catch(err => {
